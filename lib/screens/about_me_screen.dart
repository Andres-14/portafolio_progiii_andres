        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 40.0),
              child: 
                Text('● Estudie en el I.E.Arcoiris y me gradue hace 2 años. \n● Ingrese en la UNIMAR en el 2024 y actualmente curso en el 6to trimestre de Ing.De Sistemas.', style: TextStyle(fontSize: 16, color: AppTheme.alternativeColor3),
                textAlign: TextAlign.justify,
              ),
            ),
